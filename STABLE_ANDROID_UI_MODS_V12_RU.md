> **Примечание для V15:** этот документ описывает историческое состояние V12. В актуальном V15 настройки теней из Android launcher удалены; тени регулируются только внутри игры. См. `C004_ANDROID_OPTIMIZED_V15_RU.md`.
